...
const ProfileCard = () => {
    ...
    return (
        <View style={styles.container}>
            <Image source={{ uri: user.coverPhoto }} style={styles.coverPhoto} onError={(e) => console.log("Error de carga de imagen")}/>
            <View style={styles.avatarContainer}>
                <Image source={{ uri: user.avatar }} style={styles.avatar} onError={(e) => console.log("Error de carga de imagen")} />
                <Text style={styles.name}>{user.name}</Text>
            </View>
            <View style={styles.buttonContainer}>
                <TouchableOpacity onPress={() => handleLinkPress('https://www.facebook.com/lolitofdez/videos/498606625597300')}>
                    <Icon name={'facebook-gaming'} size={30} color={'blue'}/>
                </TouchableOpacity>
